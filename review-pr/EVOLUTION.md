...
- `lock-busy-concurrent-instance` **并发实例持锁导致本轮整批跳过** — 出现 4 次,首见 2026-08-25,最近 2026-08-25,status: tracked
  - 现象:prepare 未拿到锁；heartbeat daemon pid 仍在、token 匹配；open PR #300 #301 未审。不抢锁、不写 GitHub。
