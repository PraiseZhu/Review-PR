...
- `lock-busy-concurrent-instance` **并发实例持锁导致本轮整批跳过** — 出现 5 次,首见 2026-08-25,最近 2026-08-25,status: tracked
  - 现象:heartbeat daemon 仍存活并续期；本轮 3 个 open PR (#301/#305/#306) 未审。不抢锁、不写 GitHub。
