...
- `skip-security-review-package-json` **PR 改 package.json 命中 securityReviewPaths 转人工(设计行为)** — 出现 2 次,首见 2026-08-08,最近 2026-08-08,status: tracked
  - 现象:PR #580 改动含 package.json,命中 securityReviewPaths,context.mjs 判 auto.action=skip-security-review,原样跳过不 checkout 不提醒。属防自动化自我损坏闭环的设计内分流,非漏判。
