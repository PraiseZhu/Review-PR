...
function copyScriptsTo(work) {
  ...
  mkdirSync(dir);
  for (const f of ['context.mjs', 'lib.mjs', 'lib.gh-pr-view-compat.mjs', 'lib.gate-paths.mjs', 'lib.escaped-hazards.mjs', 'lib.review-profiles.mjs', 'lib.preflight-rules.mjs']) {
